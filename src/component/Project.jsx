...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <img className="rounded-t-lg" src="/src/assets/passwordpic.png" alt="" />
    
    <div className="p-5">
        <a href="https://github.com/samiyeahsan/passwordgenerator-html.git/">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{ title}</h5>
        </a>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">I did create varibale for charactors that can be choose for each password.
...
.every time user says yes to adding character it will add the value to an aarray and at the end it can create the final password. {description}</p>
